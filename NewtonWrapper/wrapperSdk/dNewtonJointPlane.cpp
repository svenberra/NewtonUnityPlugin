	...
	:dNewtonJoint()
{
	...
	CustomPlane3DOF* const joint = new CustomPlane3DOF(pivot, normal, netwonBody0, netwonBody1);
	SetJoint(joint);
}
	...
	:dNewtonJoint()
{
	...
	CustomPlane5DOF* const joint = new CustomPlane5DOF(pivot, normal, netwonBody0, netwonBody1);
	SetJoint(joint);
}
